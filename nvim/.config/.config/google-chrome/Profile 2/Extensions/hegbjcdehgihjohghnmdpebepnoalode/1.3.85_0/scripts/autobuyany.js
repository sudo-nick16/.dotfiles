...
//fkautobuy1("nokia51plusblue","Nokia 5.1 Plus (Blue, 32 GB)  (3 GB RAM)","10 01 2018 16:00:00","pid=MOBF95FJWZQSMKEV","0.6","LSTMOBF7GCRHVNFKQGRT1AYI6");
//fkautobuy1("redmi4agold3gbfl", "Redmi Note 4 Black 4GB RAM 64GB", "09 16 2017 12:00:00", "pid=9780751565355",0.6,'LSTBOK9780751565355PJBYVN');
//fkautobuy1("redminote4black4gb8feb", "Redmi Note 4 Black 4GB RAM 64GB", "05 14 2017 13:10:00", "pid=PTPDVPEXVGA2TBHE",0.6,'LSTPTPDVPEXVGA2TBHEXW8VBR');
//fkautobuy1("redminote4black4gb8feb", "Redmi Note 4 Black 4GB RAM 64GB", "05 14 2017 13:10:00", "pid=CKSEDUTZHFW5EFHV",0.6,'LSTCKSEDUTZHFW5EFHVUACEAQ');
//fkautobuy1("redmi4agrey3gbfl", "Redmi 4A (Grey,3 GB RAM, 32 GB)", "08 31 2017 12:00:00", "pid=MOBEWV2NZXYJFFHA",0.6,'LSTMOBEWV2NZXYJFFHAXDO6VD');
//fkautobuy1("redmi4agold3gbfl", "Redmi 4A (Gold,3 GB RAM, 32 GB)", "08 31 2017 12:00:00", "pid=MOBEWV2NK5KU2D6N",0.6,'LSTMOBEWV2NK5KU2D6N5OGPPD');
//fkautobuy1("mia1gold", "Xiaomi Mi A1 (Gold,4 GB RAM, 64 GB)", "09 21 2017 00:00:00", "pid=MOBEX9WXZCZHWXUZ",0.6,'LSTMOBEX9WXZCZHWXUZELHO8V');
//fkautobuy1("mia1black", "Xiaomi Mi A1 (Black,4 GB RAM, 64 GB)", "09 21 2017 00:00:00", "pid=MOBEX9WXUSZVYHET",0.6,'LSTMOBEX9WXUSZVYHETFSTZ7W');
//fkautobuy1("mimix2black", "Xiaomi Mi Mix 2 (Black,6 GB RAM, 128 GB)", "10 17 2017 12:00:00", "pid=MOBEYCHKGHZJMGJZ",0.6,'LSTMOBEYCHKGHZJMGJZP7ZBQC');
//fkautobuy1("oneplus3", "One Plus 3", "12 18 2016 16:00:00", "pid=MOBEZVCGTMQTRBBB",10);
/*fkautobuy1("lenovok6pdarkgrey4gb", "Lenovo K6 Power (Dark Grey)", "03 07 2017 00:01:00", "pid=MOBEZENFG8BPDPSU",0.6,'LSTMOBEZENFG8BPDPSUUANLO6');
fkautobuy1("lenovok6psilver4gb", "Lenovo K6 Power (Silver)", "03 07 2017 00:01:00", "pid=MOBEZENFKXZ4HSCG",0.6,'LSTMOBEZENFKXZ4HSCGC1OOAM');
fkautobuy1("lenovok6pgold4gb", "Lenovo K6 Power (Gold)", "03 07 2017 00:01:00", "pid=MOBEZENFSZGTQGWF",0.6,'LSTMOBEZENFSZGTQGWFUR1LY1');
fkautobuy1("lenovok6pdarkgrey3gb", "Lenovo K6 Power (Dark Grey)", "03 07 2017 00:01:00", "pid=MOBEZENFZBPW8UMF",0.6,'LSTMOBEZENFZBPW8UMF7P8NY0');
fkautobuy1("lenovok6pgold3gb", "Lenovo K6 Power (Gold)", "03 07 2017 00:01:00", "pid=MOBEZEMYH7FQBGBQ",0.6,'LSTMOBEZEMYH7FQBGBQRHVU0S');
fkautobuy1("lenovok6psilver3gb", "Lenovo K6 Power (Silver)", "03 07 2017 00:01:00", "pid=MOBEZEMX6CZHCJVY",0.6,'LSTMOBEZEMX6CZHCJVYOIBM0E');*/
//fkautobuy1("honor7silver", "Honor 7 (Silver)", "12 12 2016 20:15:00", "pid=MOBEBAGJF5XGY4Y9",15);
//setCookie("flippt1", 1, 30, "/checkout/init");
//fkautobuy1("mi4ktv", "Redmi Note 4 Black 4GB RAM 64GB", "04 13 2018 12:00:00", "pid=ACCEWNDZNPYDS4GB",0.6,'LSTACCEWNDZNPYDS4GBJJMZXS');
//fkautobuy1("mismarttv43", "Xiaomi Mi A1 (Black,4 GB RAM, 64 GB)", "07 27 2018 00:50:00", "pid=MOBF3T87KDNMX3GF",0.6,'LSTMOBF3T87KDNMX3GFCWGPXJ');
...
if(winloc.search(stri)> 0)
{
	...
	window.location=winloc.replace("&affid=infoindia1","");
	  ...
	  chrome.extension.sendMessage({
            autobuy1: "PAYOPTIONS1"
        }, function(response) {
        	//if(response.ptfkckout1 == "Yes") ptfkckout1 = 1;
           if(response.output1)
					 {
					 localStorage.payoption1=response.output1;
					 setCookie("payoption1", response.output1, 90000, "/checkout/init");
					 }

        });
      	  chrome.extension.sendMessage({
            mode: "defaultquantity1"
        }, function(response) {
        	//if(response.ptfkckout == "Yes") ptfkckout = 1;
           if(response.dquantity)
					 {
					 localStorage.defaultquantity1=response.dquantity;
					 setCookie("defaultquantity1", response.dquantity, 90000, "/checkout/init");
					 }

        });
			  chrome.extension.sendMessage({
            autobuy1: "IBPAYOPTIONS1"
        }, function(response) {
        	//if(response.ptfkckout1 == "Yes") ptfkckout1 = 1;
           if(response.output1)
					 {
					 localStorage.ibpayoption1=response.output1;
					 setCookie("ibpayoption1", response.output1, 90000, "/checkout/init");
					 }
     	 ...
     	 chrome.extension.sendMessage({
        	...
        	if(response.ptfkckout1 == "Yes") ptfkckout1 = 1;
           if(response.output1 == "Yes") ptfkbuy1(date,mobile,refresh,kid);
        });
}
}
...
var nexttime=getnextdate(mobdate);
    ...
    setTimeout(function() {trycallapi(kid);trycallapi(kid);trycallapi(kid);location.reload();}, 300);
  /*
	...
	$s( "div.JqLGrF" ).before("<span style='color:green;font-weight:bold;'>Captcha Copied to Clipboard: "+localStorage.jack+" Paste in the required field and confirm your order</span></br>");
         ...
         setInterval(function(){
		    	...
		    	//clearInterval(address);
					...
					else if(iiu ==4 && $s("input._3uUUD5").length && payopt1=="GIFTCARD")
