...
var Api = function () {
	...
	_createClass(Api, [{
		...
		key: 'createTicket',
		value: function createTicket(callback, data) {
			var _this = this;
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.LANGUAGE], function (storage) {
				var lang = storage[_ServiceMeta2.default.STORAGEKEYS.LANGUAGE];
				...
				chrome.runtime.getPlatformInfo(function (platformInfo) {
					...
					_this.request(_endpoints2.default.CREATETICKET, 'POST', parameter, function (response) {
						if (_Utils2.default.isResponse200(response) || _Utils2.default.isResponseMinus20(response) || _Utils2.default.isResponseMinusOne(response) || _Utils2.default.isResponseAuthError(response) || _Utils2.default.isMaintenanceMode(response)) {
							if (callback) callback(response);
						} else {
...
var BaseFinder = function () {
   ...
   */
		...
		value: function onMainWorkerDone(baselink, isWorking) {
			...
			var isSkip = baselink === _this.currentFound && _this.currentFoundTTL > _Utils2.default.getDateNow();

			_this.mainBaseResults.push({
				isWorking: isWorking,
				isSkip: isSkip,
				baselink: baselink
			});
			...
			if (isWorking && !isSkip) {
				...
				workingURLobj[_ServiceMeta2.default.STORAGEKEYS.LASTBASELINKTTL] = _Utils2.default.getDateNow() + 900;
			...
			if (_this.running === _this.countOfMain) {
				...
				for (var i = 0; i < _this.mainBaseResults.length; i++) {
					var item = _this.mainBaseResults[i];

					if (item.isWorking == true && item.isSkip == false) {
						foundWorking = true;
						break;
					}
				};

				if (!foundWorking && !_this.isSecondRunning) {
					_this.startTierSearch();
				}
			}
		}
		...
		value: function cancelMainWorkers() {
			var _this = this;
			if (_this.worker && Array.isArray(_this.worker)) {
				_this.worker.forEach(function (req) {
					try {
						req.terminate();
					} catch (e) {}
				});
