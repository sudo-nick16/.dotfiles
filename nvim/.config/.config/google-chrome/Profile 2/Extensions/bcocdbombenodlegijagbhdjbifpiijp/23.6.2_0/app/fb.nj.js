!function(){var t={createName:function(t,e){return`${t}|${JSON.stringify(e)}`},getName:e,getParams:function(){return function(t){try{return JSON.parse(t)}catch(t){return null}}(window.self.name.split("|")[1])||{}},isIframe:function(t=null){return window.self!==parent&&(!t||e()===t)}};function e(){return window.self.name.split("|")[0]||null}async function n(t,e=null){let n,o;return"number"==typeof e?(n=e,o=100):e?(n=e.timeout||3e4,o=e.frequency||100):(n=3e4,o=100),new Promise(((e,i)=>{const r=t();if(r)return void e(r);const a=setInterval((()=>{const n=t();n&&(clearInterval(a),e(n))}),o);setTimeout((()=>{clearInterval(a),e(null)}),n)}))}async function o(){await n((()=>document.body))}var i=document.documentElement,r={},a={},s={},c={},l=1;c={nextValue:function(){return(l=(9301*l+49297)%233280)/233280},seed:function(t){l=t}};var d,u,p,f="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-";function h(){p=!1}function m(t){if(t){if(t!==d){if(t.length!==f.length)throw new Error("Custom alphabet for shortid must be "+f.length+" unique characters. You submitted "+t.length+" characters: "+t);var e=t.split("").filter((function(t,e,n){return e!==n.lastIndexOf(t)}));if(e.length)throw new Error("Custom alphabet for shortid must be "+f.length+" unique characters. These characters were not unique: "+e.join(", "));d=t,h()}}else d!==f&&(d=f,h())}function g(){return p||(p=function(){d||m(f);for(var t,e=d.split(""),n=[],o=c.nextValue();e.length>0;)o=c.nextValue(),t=Math.floor(o*e.length),n.push(e.splice(t,1)[0]);return n.join("")}())}s={get:function(){return d||f},characters:function(t){return m(t),d},seed:function(t){c.seed(t),u!==t&&(h(),u=t)},lookup:function(t){return g()[t]},shuffled:g};var _="object"==typeof window&&(window.crypto||window.msCrypto),y=_&&_.getRandomValues?function(t){return _.getRandomValues(new Uint8Array(t))}:function(t){for(var e=[],n=0;n<t;n++)e.push(Math.floor(256*Math.random()));return e},b=function(t,e,n){for(var o=(2<<Math.log(e.length-1)/Math.LN2)-1,i=-~(1.6*o*n/e.length),r="";;)for(var a=t(i),s=i;s--;)if((r+=e[a[s]&o]||"").length===+n)return r};var w,v,S=function(t){for(var e,n=0,o="";!e;)o+=b(y,s.get(),1),e=t<Math.pow(16,n+1),n++;return o};var T=function(t){var e="",n=Math.floor(.001*(Date.now()-1567752802062));return n===v?w++:(w=0,v=n),e+=S(7),e+=S(t),w>0&&(e+=S(w)),e+=S(n)};var P,E=function(t){return!(!t||"string"!=typeof t||t.length<6)&&!new RegExp("[^"+s.get().replace(/[|\\{}()[\]^$+*?.-]/g,"\\$&")+"]").test(t)},C=!1;var O=(C||(C=!0,P={},P=0),P||0);function M(){return T(O)}var x=M;(a=M).generate=x;var I=function(t){return s.seed(t),a};a.seed=I;var A=function(t){return O=t,a};a.worker=A;var L=function(t){return void 0!==t&&s.characters(t),s.shuffled()};a.characters=L;var k=E;function D(t){return Array.isArray(t)?t:[t]}function R(t,e=document){t=D(t);for(const n of t){const t=e.querySelector(n);if(t)return t}return null}function F(t,e=document){t=D(t);const n=[];for(const o of t){const t=e.querySelectorAll(o);for(const e of t)n.includes(e)||n.push(e)}return n}a.isValid=k,r=a;var $={on:function(t,e){H();(N[t]||(N[t]=[])).push(e)},off:function(t,e){const n=N[t];if(!n)return;for(;;){const t=n.findIndex((t=>t===e));if(-1===t)break;n.splice(t,1)}},send:function(t,...e){let n;const o=e[e.length-1];"function"==typeof o?(n=o,e=e.slice(0,-1)):n=null;return new Promise((o=>{chrome.runtime.sendMessage({[B]:t,[q]:e},(t=>{chrome.runtime.lastError||(n&&n(t),o(t))}))}))}};const N={},B="__$chromeBus.name",q="__$chromeBus.args";function H(){const t=H;t.init||(t.init=!0,chrome.runtime.onMessage.addListener(((t,e,n)=>{const o=t["__$chromeBus.name"];if(!o)return!1;const i=t["__$chromeBus.args"]||[],r=N[o]||[];return 0!==r.length&&((async()=>{const t=await Promise.all(r.map((t=>t(...i)))),e=t[t.length-1];n(e)})(),!!n)})))}var U=$;const j="__iframeBus.name",G="__iframeBus.args",z="__iframeBus.callbackId",V="undefined"!=typeof parent&&parent!==window;function W(t,e){const n=K(t),o=e["__iframeBus.handlers"]||(e["__iframeBus.handlers"]={});o[t]=async o=>{if(o.data["__iframeBus.name"]===n){const n=o.data["__iframeBus.args"]||[],i=o.data["__iframeBus.callbackId"]||null,r=await e(...n);i&&X(`${t}:response-${i}`,r)}},window.addEventListener("message",o[t])}function Y(t,e){W(t,(function n(...o){return J(t,n),e(...o)}))}function J(t,e){const n=e["__iframeBus.handlers"]||(e["__iframeBus.handlers"]={});window.removeEventListener("message",n[t])}async function X(t,...e){let n;const o=e[e.length-1];"function"==typeof o?(n=o,e=e.slice(0,-1)):n=null;const i=t.includes(":response-"),a=K(t),s=i?null:r.generate();if(V?parent.postMessage({[j]:a,[G]:e,[z]:s},"*"):F("iframe").forEach((t=>{t.contentWindow.postMessage({[j]:a,[G]:e,[z]:s},"*")})),!i)return new Promise((e=>{const o=i=>{n&&n(i),J(`${t}:response-${s}`,o),e(i)};W(`${t}:response-${s}`,o)}))}function K(t){return`iframe-bus.${t}`}var Q={init:function(){U.on("iframe-bus",((t,...e)=>X(t,...e))),W("chrome-bus",((t,...e)=>U.send(t,...e)))},on:W,once:Y,off:J,send:X,wait:async function(t){return await new Promise((e=>{Y(t,e)}))}};function Z(t,...e){let n=0;return t.join("###").split(",").join("\n,\n").split("{").join("\n{").split("\n").map((t=>{if(!t.includes("###"))return t;const o=D(e[n]).map((e=>t.split("###").join(e))).join(",\n");return n+=1,o})).join("\n").split(";").join(" !important;").replace(/!important\s*!important/g,"!important")}function tt(...t){const e=Z(...t);document.head.insertAdjacentHTML("afterbegin",e)}var et=Object.assign((function(t,e=!1){0===nt.length&&(ot=new MutationObserver((t=>{for(const e of nt){ot.disconnect();try{e(t)}catch(t){console.error("onDocMutations",t)}if(!ot)return;ot.observe(document.documentElement,{attributes:!0,childList:!0,subtree:!0})}})),ot.observe(document.documentElement,{attributes:!0,childList:!0,subtree:!0}));nt.push(t),e&&t()}),{off:function(t){const e=nt.indexOf(t);if(-1===e)return;nt.splice(e,1),0===nt.length&&(ot.disconnect(),ot=null)}});const nt=[];let ot;var it={controller:{getConfig:function e(){const n=e;if(!n.config){const e=t.getParams();n.config=e.fusionConfig}return n.config}}},rt=function(){tt`
  ...
  `,$t((t=>{if(!t.target.closest(zt.sidePanel.locationRoot))return;const e=R(zt.sidePanel.locationInput);e?e.focus():gt.sendError({message:"upgradeAddLocationButton: failed to find location input"})})),tt`
    <style>
  ...
  `}(),function(){const t=Symbol("handled");et((()=>{const e=R(zt.general.headerMessageIconContainer);if(!e)return;if(e[t])return;e[t]=!0;e.parentElement.style.display="none"}))}(),ee()}};let zt,Vt;function Wt(t){location.href=t}async function Yt(t,{isIgtv:e=!1}={}){document.documentElement.classList.toggle("is-igtv",e);const n=window.inssist.schedule.requireModule,o=await n(Vt.queryIGMediaData),i=await n(Vt.MediaManagerInstagramContentActions);await te(),ct.selectedPostId=t;const r=await Ft(o,t);"POSTED"===r.postStatus?(i.setShouldShowPostDetailTray(!0,r),qt.restoreCaptionForCurrentPost()):(await ie(),i.editPost(r),qt.restoreCaptionForCurrentPost())}async function Jt({postMode:t="publish",localPostId:e=null,localPostFiles:n=[]}){const o=Jt;document.documentElement.classList.toggle("is-igtv",!1),ct.crosspostToFb=!1,ct.selectedPostId=e||null,await te();const i=window.inssist.schedule.requireModule;await ie();(await i(Vt.MediaManagerInstagramComposerRootActions)).openComposer(Vt.IG_FEED_ORGANIC),Dt.dispatch({type:Vt.SELECT_INSTAGRAM_ACCOUNT,instagramAccount:ct.user}),Dt.dispatch({type:Vt.SWITCH_POST_MODE,[Vt.isEditComposer]:!1,[Vt.postMode]:t}),qt.restoreCaptionForCurrentPost(),0!==n.length&&(clearTimeout(o.timeout),o.timeout=setTimeout((()=>{Dt.dispatch({type:Vt.FILES_ADDED,[Vt.files]:n})}),200))}function Xt(){location.href=Et()}async function Kt(){return!!window.require}async function Qt(){const t=window.inssist.schedule.requireModule,e=await t(Vt.MediaManagerInstagramComposerUploadStore);return await new Promise((t=>{const n=setInterval((()=>{const o=e.getState().toJS(),i=o.isUploadFailed,r=o.isUploadFinished;i?(clearInterval(n),t(!1)):r&&(clearInterval(n),t(!0))}),500)}))}function Zt(){Dt.dispatch({type:"PUBLISH_MEDIA"})}async function te(){const t=window.inssist.schedule.requireModule;(await t(Vt.MediaManagerInstagramContentActions)).setShouldShowPostDetailTray(!1),Dt.dispatch({type:Vt.SHOW_EXIT_COMPOSER_CONFIRM_DIALOG}),Dt.dispatch({type:Vt.CLOSE_COMPOSER,fromInssist:!0})}function ee(){const t=ee;t.init||(t.init=!0,t.lastPostCount=0,Dt.onDispatch((e=>{if(t.refreshing&&e.type===Vt.SET_CONTENT_LIBRARY_DATA){const n=e.queryParameters.toJS().postType;if(!(n===Vt.POST_TYPE_IGTV||n===Vt.POST_TYPE_VIDEOS||n===Vt.POST_TYPE_PHOTOS||n===Vt.POST_TYPE_CAROUSELS))return;if(n===Vt.POST_TYPE_IGTV)return void Dt.dispatch({type:Vt.SELECT_CONTENT_TABLE,contentTable:Vt.INSTAGRAM_VIDEO_POSTS,source:Vt.instagram_content_library_posts});n===Vt.POST_TYPE_VIDEOS&&Dt.dispatch({type:Vt.SELECT_CONTENT_TABLE,contentTable:Vt.INSTAGRAM_PHOTO_POSTS,source:Vt.instagram_content_library_posts}),n===Vt.POST_TYPE_PHOTOS&&Dt.dispatch({type:Vt.SELECT_CONTENT_TABLE,contentTable:Vt.INSTAGRAM_CAROUSEL_POSTS,source:Vt.instagram_content_library_posts});const o=e.data.data.toJS();for(const t of o)Nt(ct.allPosts,(e=>e.id===t.id)),ct.allPosts.push(t);if(n===Vt.POST_TYPE_CAROUSELS){if(t.lastPostCount-ct.allPosts.length>3)return t.lastPostCount=0,t.refreshing=!1,void ee();t.lastPostCount=ct.allPosts.length,Q.send("schedule.apply-fcs-posts",ct.allPosts),t.refreshing=!1}}}))),t.refreshing||(ct.allPosts.length=[],t.refreshing=!0,Dt.dispatch({type:Vt.SELECT_CONTENT_TABLE,contentTable:Vt.INSTAGRAM_IGTV_POSTS,source:Vt.instagram_content_library_posts}),Dt.dispatch({type:Vt.REFRESH_TAB,tab:Vt.instagram_content_posts}))}function ne(){et((()=>{F("video").forEach((t=>{t.hasAttribute("autoplay")&&(t.pause(),t.removeAttribute("autoplay"))}))}),!0)}function oe(){history.pushState=history.replaceState}async function ie(){const t=window.inssist.schedule.requireModule,e=await t(Vt.MediaManagerLazyLoadActions);await Ft(e.lazyLoadSection,Vt.INSTAGRAM_COMPOSER)}var re={init:async function(){if(await xt.waitForInit(),await Dt.waitForInit(),!ct.user)return;ae=it.controller.getConfig().fcsSelectors,se=it.controller.getConfig().fcs,$t((t=>{t.target.closest(ae.upload.root)&&(t.target.closest("input")||t.target.closest("button")||ce(R(ae.upload.button)))})),tt`
    <style>
      ${ae.upload.root} {
        border-radius: 7px;
        user-select: none;
  ...
  `}(),function(){const t=Symbol("handled");et((()=>{const e=R(".add-media");if(!e)return;const n=R(ae.sidePanel.mediaList);if(!n)return;const o=R(".reverse-media-list-button");if(o){const t=n.childElementCount<=1?"none":null;o.style.setProperty("display",t,"important")}if(e[t])return;e[t]=!0,e.insertAdjacentHTML("afterend",'\n      <button class="reverse-media-list-button" type="button">\n        <span class="reverse-media-list-button__icon">↪︎</span>\n        REVERSE\n      </button>\n    ');R(".reverse-media-list-button").addEventListener("click",(async()=>{try{const t=window.inssist.schedule.requireModule,e=(await t(se.MediaManagerInstagramComposerUploadStore)).getState().toObject().fileMap.toObject(),n=Object.keys(e);if(n.length<2)return;n.forEach(((t,e)=>{Dt.dispatch({type:se.SUBMIT_MEDIA_ORDER,[se.mediaOrderId]:t,[se.prevIndex]:0,[se.newIndexString]:String(n.length-e),[se.totalMedia]:n.length})}))}catch(t){console.error("schedule injection media controller →","addReverseMediaButton",t)}}))})),tt`
    <style>
  ...
  `}(),async function(){const t=window.inssist.schedule.requireModule,e=await t(se.ImageExifRotation);if(!e)return;e.getRotation=(t,e)=>(e&&"function"==typeof e&&e(0),0)}()}};let ae,se;function ce(t){t||gt.throwError({message:"startUpload: failed to find upload button"}),t.click();const e=R(ae.upload.input);e||gt.throwError({message:"startUpload: failed to find upload input"});const n=e.closest(ae.tooltip.root);n||gt.throwError({message:"startUpload: failed to find upload tooltip"}),n.style.opacity=0,n.style.pointerEvents="none",e.click()}var le={init:async function(){de=it.controller.getConfig().fcsSelectors,Q.on("schedule.connect-via-fb",ue),Q.on("schedule.connect-via-ig",pe)}};let de;async function ue(){if(await Dt.waitForInit(),!Dt.dispatch)return{error:"failed-to-init-dispatcher"};const t=await n((()=>R(".MediaManagerInstagramContentPostsTabContainer")||R('[role="tab"][aria-selected="true"]')?"content":R(".MediaManagerInstagramOnboardingScreen")?"welcome":null));if(!t)return{error:"failed-to-detect-page-type"};"content"===t&&(Dt.dispatch({type:"SELECT_TAB",tab:"instagram_accounts",source:"left_nav"}),await n((()=>location.href.includes("instagram_accounts"))),await n((()=>R(".MediaManagerInstagramTabHeaderContainer")))),Dt.dispatch({type:"SET_SHOW_INSTAGRAM_ONBOARDING_DIALOG",shown:!0}),await n((()=>R(".MediaManagerInstagramAccountPermissionMessageDialog")));const e=await new Promise((t=>{let e;const o=window.open;window.open=(i,r,a)=>{if(!i.includes("/oauth/authorize/"))return o(i,r,a);(async()=>{a=fe();const s=o(i,r,a);window.open=o,await n((()=>s.closed)),e=setTimeout((()=>{t({error:"auth-window-closed-by-user"})}),5e3)})()};const i=window.require("ReloadPage"),r=i.now;i.now=()=>{clearTimeout(e),i.now=r,t({success:!0})},Dt.onDispatch((n=>{clearTimeout(e),"SET_LOGIN_INSTAGRAM_ACCOUNT_SUCCESS"===n.type&&t({error:"not-connected-to-fb-page"})})),Dt.dispatch({type:"AUTHENTICATE_INSTAGRAM_USER"})}));return Dt.dispatch({type:"SELECT_TAB",tab:"instagram_content",source:"left_nav"}),await n((()=>location.href.includes("instagram_content"))),e}async function pe(){if(await Dt.waitForInit(),!Dt.dispatch)return{error:"failed-to-init-dispatcher"};if(R(de.general.fbLoginRequiredContainer))return{error:"failed-to-skip-fb-login"};return await new Promise((t=>{let e;const o=window.open;window.open=(i,r,a)=>{if(!(i=i.toString()).includes("/oauth/authorize/"))return o(i,r,a);(async()=>{a=fe();const s=o(i,r,a);window.open=o,await n((()=>s.closed)),e=setTimeout((()=>{t({error:"auth-window-closed-by-user"})}),5e3)})()};const i=window.require("URI"),r=i.goURIOnWindow;i.goURIOnWindow=(...n)=>{clearTimeout(e),i.goURIOnWindow=r,t({success:!0})},Dt.dispatch({type:"IG_AUTHENTICATION_LOG_IN"})}))}function fe(){return`scrollbars,top=${Math.round(screen.height/2-350)},left=${Math.round(screen.width/2-300)},width=600,height=700`}var he={init:async function(){if(me=it.controller.getConfig().fcsSelectors,ge=it.controller.getConfig().fcs,await xt.waitForInit(),await Dt.waitForInit(),!ct.user)return;(function(){let t,e;et((()=>{t=F(me.sidePanel.mediaPreview),e=R(me.sidePanel.mediaPreviewVideo)})),ft.onRequest((({url:n,onResponse:o})=>{if(!function(t){return t.includes(ge["/media/manager/instagram_composer/create_post"])}(n))return;let i,r;i=t.length>1?"carousel":e?"video":"photo",t.length>0?r=t[0].getAttribute("src"):console.error("failed to find media preview image"),Q.send("schedule.fcs-create-post-request",{type:i,image:r,crosspostToFb:ct.crosspostToFb,localPostId:ct.selectedPostId||null}),o((()=>{Q.send("schedule.fcs-create-post-response",{image:r})}))})),ft.onRequest((({url:t,query:e,onResponse:n})=>{if(!function(t){return t.includes(ge["/media/manager/instagram_media/edit/save"])}(t))return;const o=ct.selectedPostId;let i,r;"true"===e[ge["edit_data[save_as_draft]"]]?(i=null,r="draft"):"true"===e[ge["edit_data[save_as_scheduled]"]]?(i=_e,r="scheduled"):(i=null,r="posted"),Q.send("schedule.fcs-edit-post-request",{postId:o,status:r,on:i}),n((t=>{Q.send("schedule.fcs-edit-post-response",{postId:o,status:r})}))}))})(),function(){const t=ge.MIN_MINUTES_FROM_NOW;tt`
    <style>
      ${me.dateDialog.root} {
        position: fixed;
        left: -10000px;
  ...
  `;let e=!1;et((()=>{const t=R(me.dateDialog.rootOpen);(!e&&t||e&&!t)&&(e=!e,Q.send("schedule.fcs-date-dialog-toggled",e))}));const n=Symbol("handled");et((()=>{const e=R(me.sidePanel.save);e&&(e[n]||e.nextElementSibling&&(e[n]=!0,e.addEventListener("click",(e=>{const n=Date.now()+t*wt;"schedule"===ye&&(!_e||_e<n)&&(e.preventDefault(),e.stopPropagation(),Q.send("schedule.fcs-date-dialog-invalid-time"))}),!0)))}))}(),async function(){const t=async()=>await Q.send("schedule.has-pro"),e=Symbol("handled");et((()=>{const n=R(me.sidePanel.save);if(!n)return;if(n[e])return;n[e]=!0;let o=!0;n.addEventListener("click",(e=>{o?(e.preventDefault(),e.stopPropagation(),(async()=>{if(await t())return o=!1,void n.click();const e=R(me.sidePanel.dateDialogTrigger);e&&e.click(),Q.send("schedule.show-upsell")})()):o=!0}),!0)}))}(),Q.on("schedule.fcs-date-dialog-get-timezone",be),Q.on("schedule.fcs-date-dialog-select-option",we),Q.on("schedule.fcs-date-dialog-set-selected-option",ve),Q.on("schedule.fcs-date-dialog-set-publish-time",Se)}};let me,ge,_e=null,ye=null;function be(){const t=window.require(ge.DateTime).localNow().getTimezoneID();return window.require(ge.TimezoneNamesData).zoneNames[t]}function we(t){const e={"publish-now":ge.postModePublish,"save-as-draft":ge.postModeDraft,schedule:ge.postModeSchedule}[t],n={type:ge.SWITCH_POST_MODE,[ge.postMode]:e};Dt.dispatch({...n,[ge.isEditComposer]:!1}),Dt.dispatch({...n,[ge.isEditComposer]:!0})}function ve(t){ye=t}function Se(t){if(_e=t,!_e)return;const e={type:ge.SELECT_SCHEDULED_DATE,[ge.scheduledDate]:new Date(_e)};Dt.dispatch({...e,[ge.isEditComposer]:!1}),Dt.dispatch({...e,[ge.isEditComposer]:!0})}var Te={init:async function(){if(await xt.waitForInit(),await Dt.waitForInit(),!ct.user)return;Pe=it.controller.getConfig().fcsSelectors,Ee=it.controller.getConfig().fcs,tt`
    <style>
      ${Pe.postToFb.root} {
        display: none;
      }
    </style>
  `;const t=ct.user.connectedPageInfo;if(!t)return;t.url=`https://facebook.com/${t.name}-${t.id}`;t.name.toLowerCase().startsWith("inssist:")||(function(t){const e=Symbol("handled");et((()=>{const t=R(Pe.postToFb.checkboxRow);if(!t)return;const e=!!R(Pe.sidePanel.mediaList);t.style.opacity=e?null:.5}),!0),et((()=>{const t=R(Pe.postToFb.title);t&&!t[e]&&(t[e]=!0,t.innerText="Clone to Facebook");const n=R(Pe.postToFb.body);n&&!n[e]&&(n[e]=!0,n.innerHTML='\n        <div class="post-to-fb__text">\n          Post will be cloned to Facebook Page. Facebook posts\n          can be managed separately from the\n          <a\n            class="post-to-fb__link"\n            href="https://business.facebook.com/creatorstudio/"\n            target="_blank">\n            Facebook Creator Studio</a>.\n        </div>\n      ')}),!0),et((()=>{const t=R(Pe.postToFb.checkboxRow);if(!t)return;if(t[e])return;t[e]=!0;const n=R(Pe.postToFb.checkboxButton);n&&t.addEventListener("click",(t=>{t.target.closest(Pe.postToFb.checkboxButton)||n.click()}))})),tt`
    <style>
  ...
  `}(),function(){let t,e;Q.on("schedule.fcs-date-dialog-set-selected-option",(e=>{t=e,n()})),Q.on("schedule.fcs-date-dialog-set-publish-time",(t=>{e=t,n()})),Dt.onDispatch((t=>{t.type===Ee.TOGGLE_CROSSPOST_TO_FACEBOOK_CHECKBOX&&n()}));const n=()=>{"save-as-draft"===t?Dt.dispatch({type:Ee.SWITCH_CROSSPOST_POST_MODE,[Ee.postMode]:Ee.postModeDraft}):"publish-now"===t?Dt.dispatch({type:Ee.SWITCH_CROSSPOST_POST_MODE,[Ee.postMode]:Ee.postModePublish}):"schedule"===t&&(Dt.dispatch({type:Ee.SWITCH_CROSSPOST_POST_MODE,[Ee.postMode]:Ee.postModeSchedule}),e&&Dt.dispatch({type:Ee.SELECT_CROSSPOST_SCHEDULED_DATE,[Ee.scheduledDate]:new Date(e)}))}}(),function(t){const e=Symbol("handled");et((async()=>{const n=R(".delete-post-button");if(!n)return;if(n[e])return;n[e]=!0;const o=await Q.send("schedule.get-post",ct.selectedPostId);if(!o)return;if(!o.crosspostToFb)return;let i;i="draft"===o.status?`${t.url}/publishing_tools?section=DRAFTS`:"scheduled"===o.status?`${t.url}/publishing_tools?section=SCHEDULED_POSTS`:`${t.url}/publishing_tools`,n.insertAdjacentHTML("afterend",`\n      <a\n        class="manage-fb-posts-link"\n        href="${i}"\n        target="_blank">\n        MANAGE FACEBOOK POSTS\n      </a>\n      <div style="flex-grow: 1"></div>\n    `)}),!0),tt`
    <style>
