...
class TableShow {
  ...
  displayHeaderActionWrap () {
    ...
    const inlineAction = newElement('a', {
      title: chrome.i18n.getMessage('inlineDescription'),
      className: 'b-action',
      click: this.inLineDisplay.bind(this),
      html: chrome.i18n.getMessage('inlineAction'),
    });
    ...
    actionWrap.appendChild(inlineAction);
  ...
  inLineDisplay () {
    this.activityLogger_.logEvent('popup-action-inline', {});
